...
namespace MyProject.WebApiServices.Constants
{
    public static class URLs
    {
        ...
        public static class Order
        {
            ...
            public const string GetTrackHistory = "~/api/order/GetTrackHistory/{airWayBillNumberNumber}";
        ...
        public static class Tracking
        {
            ...
            public const string GetTrackingByOrderId = "~/api/Tracking/GetTrackingByOrderId/{OrderId}";
